...
class QSqlDatabase;
class SetTilesTableModel;
class TileSetsTableModel;
class TilesTableModel;
class TilesDownloadTableModel;
...
private:
    ...
    SetTilesTableModel *_setTilesTable = nullptr;
    TileSetsTableModel *_tileSetsTable = nullptr;
    TilesTableModel *_tilesTable = nullptr;
    TilesDownloadTableModel *_tilesDownloadTable = nullptr;
