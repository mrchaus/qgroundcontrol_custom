...
public:
    ...
    explicit LogReplayLinkConfiguration(LogReplayLinkConfiguration *copy, QObject *parent = nullptr);
    ...
    LinkType type() override { return LinkConfiguration::TypeLogReplay; }
