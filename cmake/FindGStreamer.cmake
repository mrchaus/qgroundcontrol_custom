...
if(NOT GST_PLUGINS_FOUND)
    ...
    # if(ANDROID)
        ...
        if(graphene_LIBRARY)
            target_link_libraries(GStreamer::GStreamer INTERFACE ${graphene_LIBRARY})
        endif()

        find_library(x264_LIBRARY x264)
        if(x264_LIBRARY)
            target_link_libraries(GStreamer::GStreamer INTERFACE ${x264_LIBRARY})
        endif()
        ...
        find_package(EGL)
        if(EGL_FOUND)
            target_link_libraries(GStreamer::GStreamer INTERFACE EGL::EGL)
        endif()
